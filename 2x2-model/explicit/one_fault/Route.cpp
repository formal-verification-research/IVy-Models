...
void route(int cur_x, int cur_y, int dest_x, int dest_y, int faulty_x1, int faulty_y1, char faulty_dir1) 
{
  // int cur_x = 2;
  // int cur_y = 0;
  // int dest_x = 1;
  ...
  filename << "s" << start_x << start_y << "_d" << dest_x << dest_y << "_f" << faulty_x1 << faulty_y1 << direction(faulty_dir1);
