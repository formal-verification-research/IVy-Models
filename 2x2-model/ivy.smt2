...
(assert
 (let (($x134 (= r_E_00.id __spec.flit_to_watch)))
 ...
 (let (($x72 (and (and |r_W_10.assigned:2| (and |r_W_10.assigned:1| true)) (and false (and false true)))))
 (let (($x88 (and (= |r_W_10.assigned:2| false) (= |r_W_10.assigned:1| false) (= |r_W_10.assigned:0| false))))
 (let (($x23 (not (and r_W_10.has_flit (or $x88 $x72) r_S_11.has_flit (or $x124 $x66)))))
 (and $x23 $x187 $x452 $x233 $x173 __r_E_00.has_flit $x134 (or (not __ts0_a) (not (<= r_E_00.tally 5))) (or (not __ts0_a) (= spec.flit_to_watch __spec.flit_to_watch)) (or (not __ts0_a) (= r_E_00.tally (+ __r_E_00.tally 1))) (or (not __ts0_a) (= r_E_00.has_flit __r_E_00.has_flit)) (or __ts0_a or) (= __ts0_a (< __r_E_00.tally 5))))))))))))))
(assert
 (and (not or)))
(check-sat)
