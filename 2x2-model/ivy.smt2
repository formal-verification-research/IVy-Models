...
(assert
 (let (($x45 (and (and |__new_fml:a_a:2| (and |__new_fml:a_a:1| true)) (and |__fml:a:2| (and |__fml:a:1| true)))))
 (let (($x38 (and (= |__new_fml:a_a:2| |__fml:a:2|) (= |__new_fml:a_a:1| |__fml:a:1|) (= |__new_fml:a_a:0| |__fml:a:0|))))
 ...
 (and r_PE_10.has_flit r_PE_10.ready (not $x7) (= |__new_fml:f_a| |__fml:f|) (or $x23 (and (and |__new_fml:r_a:2| true) (and |__fml:r:2| true))) (or $x38 $x45)))))))
(assert
 (and (not or)))
(check-sat)
