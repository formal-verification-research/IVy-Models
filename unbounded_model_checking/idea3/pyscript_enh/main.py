...
while not(finished): # and index < 200:
	...
	if check_failed(tempfilename):
		...
		if index == 0:
			print("\033[0;30;42mNO LIVELOCK OR DROPS FOUND! HIP HIP HOORAY!\033[0m")
		finished = True
		break
