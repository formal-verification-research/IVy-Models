...
index = int(input("\033[0;30;43mWhat index would you like the program to start at? Default is 0. \033[0;37;44m"))

os.system("mkdir " + foldername)
os.system("cp -i " + filename + ".ivy " + foldername + "/" + str(index) + ".ivy")
...
while not(finished) and index < 64:
	...
	logfile.write("Checked: " + str(index - 1) + " in " + str(round(general_timer_duration,2)) + " seconds. (" + new_invariant + ")\n")
	print("[" + str(index - 1) + "] completed ", end = "")
